...
using FourSolid.Cqrs.OrdiniClienti.ApplicationServices.Hubs;
...
namespace FourSolid.Cqrs.OrdiniClienti
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info
                {
                    Title = "4Solid",
                    Version = "v1",
                    Description = "Web Api Services for OrdiniClienti",
                    TermsOfService = ""
                });

                var pathDoc = "FourSolid.Cqrs.OrdiniClienti.xml";
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, IApplicationLifetime applicationLifetime)
        {
            ...
            {
                routes.MapHub<OrdiniClientiHub>("/ordiniclienti");
            });
            #endregion
